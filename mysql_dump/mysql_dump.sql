...
CREATE DATABASE /*!32312 IF NOT EXISTS*/ `mytestDB` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */;
...
--
-- Current Database: `periodicalsDB`
--

CREATE DATABASE /*!32312 IF NOT EXISTS*/ `periodicalsDB` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */;
...
INSERT INTO `roles` VALUES (1,'admin',2),(2,'customer',2),(3,'anonymous',2);
...
CREATE TABLE `user` (
  ...
  CONSTRAINT `user_fk0` FOREIGN KEY (`role_id`) REFERENCES `roles` (`id`)
...
INSERT INTO `user` VALUES (1,'admin','admin',1,'Admin','Adminovich','admin@admin.com','+375295556666','230025, Grodno, Kirova str., 1 ',1);
...
-- Dump completed on 2018-11-30  0:38:48
